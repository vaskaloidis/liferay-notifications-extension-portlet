		...
		var NotificationsList = A.Component.create(
			{
				...
				prototype: {
					initializer: function(config) {
						...
						instance._deleteAllNode = config.deleteAllNode;
								...
								on: {
									success: function() {
										...
										if (response) {
											...
											var deleteAllNode = notificationsContainer.one(instance._deleteAllNode);
											var deleteAllLink;
											
											if (deleteAllNode) {
												deleteAllLink = deleteAllNode.one('a');
											}
											...
											if (!hasEntries) {
												...
												if(deleteAllLink) {
													deleteAllLink.toggle(!instance._actionable && newUserNotificationEventsCount > 0);
												}
						...
						if (deleteAllNode) {
							deleteAllNode.on(
								...
								function(event) {
									...
									portletURL.setParameter('javax.portlet.action', 'deleteAllUserNotificationEvents');
